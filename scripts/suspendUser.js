...
/*           
 * suspendUser - Suspend PingID User
 *
...
function pingid_suspend_user(pingid_username, callback) {

	var operationEndpoint = "suspenduser/do";
	var payload = {
...
pingid_suspend_user(userName, function(apiResponse) {
